...
export 'embed.pbenum.dart';

class Embed_DoubleEmbed extends $pb.GeneratedMessage {
  factory Embed_DoubleEmbed() => create();

  Embed_DoubleEmbed._();

  factory Embed_DoubleEmbed.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Embed_DoubleEmbed.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Embed.DoubleEmbed',
  ...
  Embed_DoubleEmbed copyWith(void Function(Embed_DoubleEmbed) updates) =>
      super.copyWith((message) => updates(message as Embed_DoubleEmbed))
          as Embed_DoubleEmbed;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Embed_DoubleEmbed create() => Embed_DoubleEmbed._();
  @$core.override
  Embed_DoubleEmbed createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static Embed_DoubleEmbed getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Embed_DoubleEmbed>(create);
  static Embed_DoubleEmbed? _defaultInstance;
}
