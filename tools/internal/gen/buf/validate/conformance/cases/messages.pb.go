...
type MessageOneofMulipleFieldsRequired struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StrField      string                 `protobuf:"bytes,1,opt,name=str_field,json=strField,proto3" json:"str_field,omitempty"`
	BoolField     bool                   `protobuf:"varint,2,opt,name=bool_field,json=boolField,proto3" json:"bool_field,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *MessageOneofMulipleFieldsRequired) Reset() {
	*x = MessageOneofMulipleFieldsRequired{}
	mi := &file_buf_validate_conformance_cases_messages_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MessageOneofMulipleFieldsRequired) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageOneofMulipleFieldsRequired) ProtoMessage() {}

func (x *MessageOneofMulipleFieldsRequired) ProtoReflect() protoreflect.Message {
	mi := &file_buf_validate_conformance_cases_messages_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageOneofMulipleFieldsRequired.ProtoReflect.Descriptor instead.
func (*MessageOneofMulipleFieldsRequired) Descriptor() ([]byte, []int) {
	return file_buf_validate_conformance_cases_messages_proto_rawDescGZIP(), []int{12}
}

func (x *MessageOneofMulipleFieldsRequired) GetStrField() string {
	if x != nil {
		return x.StrField
	}
	return ""
...
func (x *MessageOneofMulipleFieldsRequired) GetBoolField() bool {
	if x != nil {
		return x.BoolField
	}
	return false
...
const file_buf_validate_conformance_cases_messages_proto_rawDesc = "" +
	...
	"\n" +
	"bool_field\"\x7f\n" +
	"!MessageOneofMulipleFieldsRequired\x12\x1b\n" +
	"\tstr_field\x18\x01 \x01(\tR\bstrField\x12\x1d\n" +
	"\n" +
...
var file_buf_validate_conformance_cases_messages_proto_goTypes = []any{
	...
	(*MessageOneofMulipleFieldsRequired)(nil), // 12: buf.validate.conformance.cases.MessageOneofMulipleFieldsRequired
