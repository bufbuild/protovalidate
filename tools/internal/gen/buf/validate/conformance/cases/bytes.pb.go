...
var (
	...
	file_buf_validate_conformance_cases_bytes_proto_rawDescData []byte
)
...
func file_buf_validate_conformance_cases_bytes_proto_rawDescGZIP() []byte {
	file_buf_validate_conformance_cases_bytes_proto_rawDescOnce.Do(func() {
		file_buf_validate_conformance_cases_bytes_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_buf_validate_conformance_cases_bytes_proto_rawDesc), len(file_buf_validate_conformance_cases_bytes_proto_rawDesc)))
	})
