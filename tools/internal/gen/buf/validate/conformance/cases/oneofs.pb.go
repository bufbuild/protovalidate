...
func (x *OneofIgnoreEmpty) Reset() {
	*x = OneofIgnoreEmpty{}
	if protoimpl.UnsafeEnabled {
		mi := &file_buf_validate_conformance_cases_oneofs_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OneofIgnoreEmpty) Descriptor() ([]byte, []int) {
	return file_buf_validate_conformance_cases_oneofs_proto_rawDescGZIP(), []int{5}
}
...
var file_buf_validate_conformance_cases_oneofs_proto_rawDesc = []byte{
	...
	,
...
var file_buf_validate_conformance_cases_oneofs_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_buf_validate_conformance_cases_oneofs_proto_goTypes = []interface{}{
	...
	(*OneofIgnoreEmpty)(nil),               // 5: buf.validate.conformance.cases.OneofIgnoreEmpty
}
...
func file_buf_validate_conformance_cases_oneofs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_buf_validate_conformance_cases_oneofs_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_buf_validate_conformance_cases_oneofs_proto_msgTypes[5].OneofWrappers = []interface{}{
