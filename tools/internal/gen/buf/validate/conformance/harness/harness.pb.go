...
func (x *TestResult) GetValidationError() *ValidationError {
...
type TestResult_ValidationError struct {
	...
	ValidationError *ValidationError `protobuf:"bytes,2,opt,name=validation_error,json=validationError,proto3,oneof"`
}
...
func (x *ValidationError) Reset() {
	*x = ValidationError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_buf_validate_conformance_harness_harness_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ValidationError) Descriptor() ([]byte, []int) {
	return file_buf_validate_conformance_harness_harness_proto_rawDescGZIP(), []int{3}
}
...
type Violation struct {
	...
	ConstraintId *string `protobuf:"bytes,2,opt,name=constraint_id,json=constraintId,proto3,oneof" json:"constraint_id,omitempty"`
	// `message` is a human-readable error message that describes the nature of the violation.
	// This can be the default error message from the violated `Constraint`, or it can be a custom message that gives more context about the violation.
	Message *string `protobuf:"bytes,3,opt,name=message,proto3,oneof" json:"message,omitempty"`
	// `for_key` indicates whether the violation was caused by a map key, rather than a value.
	ForKey *bool `protobuf:"varint,4,opt,name=for_key,json=forKey,proto3,oneof" json:"for_key,omitempty"`
}

func (x *Violation) Reset() {
	*x = Violation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_buf_validate_conformance_harness_harness_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Violation) Descriptor() ([]byte, []int) {
	return file_buf_validate_conformance_harness_harness_proto_rawDescGZIP(), []int{4}
}
...
var file_buf_validate_conformance_harness_harness_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x1a, 0x19, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0xfd, 0x01, 0x0a, 0x16, 0x54, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61,
	0x6e, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x38, 0x0a, 0x05, 0x66, 0x64,
	0x73, 0x65, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	...
	0x64, 0x73, 0x65, 0x74, 0x12, 0x59, 0x0a, 0x05, 0x63, 0x61, 0x73, 0x65, 0x73, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x43, 0x2e, 0x62, 0x75, 0x66, 0x2e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61,
	0x74, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x68,
	0x61, 0x72, 0x6e, 0x65, 0x73, 0x73, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x6f,
	0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x43, 0x61,
	0x73, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x05, 0x63, 0x61, 0x73, 0x65, 0x73, 0x1a,
	0x4e, 0x0a, 0x0a, 0x43, 0x61, 0x73, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x2f, 0x68, 0x61, 0x72, 0x6e, 0x65, 0x73,
	0x73, 0xa2, 0x02, 0x04, 0x42, 0x56, 0x43, 0x48, 0xaa, 0x02, 0x20, 0x42, 0x75, 0x66, 0x2e, 0x56,
	0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61,
	0x6e, 0x63, 0x65, 0x2e, 0x48, 0x61, 0x72, 0x6e, 0x65, 0x73, 0x73, 0xca, 0x02, 0x20, 0x42, 0x75,
	0x66, 0x5c, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x5c, 0x43, 0x6f, 0x6e, 0x66, 0x6f,
	0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x5c, 0x48, 0x61, 0x72, 0x6e, 0x65, 0x73, 0x73, 0xe2, 0x02,
	0x2c, 0x42, 0x75, 0x66, 0x5c, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x5c, 0x43, 0x6f,
	...
	0x6f, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x3a, 0x3a, 0x48, 0x61, 0x72, 0x6e,
...
var file_buf_validate_conformance_harness_harness_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_buf_validate_conformance_harness_harness_proto_goTypes = []any{
	...
	(*ValidationError)(nil),                // 3: buf.validate.conformance.harness.ValidationError
	(*Violation)(nil),                      // 4: buf.validate.conformance.harness.Violation
	nil,                                    // 5: buf.validate.conformance.harness.TestConformanceRequest.CasesEntry
	nil,                                    // 6: buf.validate.conformance.harness.TestConformanceResponse.ResultsEntry
...
var file_buf_validate_conformance_harness_harness_proto_depIdxs = []int32{
	7, // 0: buf.validate.conformance.harness.TestConformanceRequest.fdset:type_name -> google.protobuf.FileDescriptorSet
	5, // 1: buf.validate.conformance.harness.TestConformanceRequest.cases:type_name -> buf.validate.conformance.harness.TestConformanceRequest.CasesEntry
	6, // 2: buf.validate.conformance.harness.TestConformanceResponse.results:type_name -> buf.validate.conformance.harness.TestConformanceResponse.ResultsEntry
	3, // 3: buf.validate.conformance.harness.TestResult.validation_error:type_name -> buf.validate.conformance.harness.ValidationError
	4, // 4: buf.validate.conformance.harness.ValidationError.violations:type_name -> buf.validate.conformance.harness.Violation
	8, // 5: buf.validate.conformance.harness.TestConformanceRequest.CasesEntry.value:type_name -> google.protobuf.Any
	2, // 6: buf.validate.conformance.harness.TestConformanceResponse.ResultsEntry.value:type_name -> buf.validate.conformance.harness.TestResult
...
func file_buf_validate_conformance_harness_harness_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_buf_validate_conformance_harness_harness_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_buf_validate_conformance_harness_harness_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_buf_validate_conformance_harness_harness_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_buf_validate_conformance_harness_harness_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_buf_validate_conformance_harness_harness_proto_msgTypes[4].Exporter = func(v any, i int) any {
	...
	file_buf_validate_conformance_harness_harness_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
