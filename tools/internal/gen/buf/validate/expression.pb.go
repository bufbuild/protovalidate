...
var file_buf_validate_expression_proto_rawDesc = []byte{
	...
	0x79, 0x42, 0xb7, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x75, 0x66, 0x2e, 0x76, 0x61,
	...
	0x66, 0x3a, 0x3a, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
func file_buf_validate_expression_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_buf_validate_expression_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_buf_validate_expression_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_buf_validate_expression_proto_msgTypes[2].Exporter = func(v any, i int) any {
