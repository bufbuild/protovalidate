	...
	return suites.Suite{
		...
		"const/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("enum.const")}),
		},
		"alias/const/valid": {
		...
		"defined_only/invalid/unknown": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("enum.defined_only"), Message: proto.String("value must be one of the defined enum values")}),
		},
		...
		"alias/defined_only/invalid/unknown": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("enum.defined_only")}),
		},
		"in/valid": {
		...
		"in/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("enum.in")}),
		},
		"alias/in/valid": {
		...
		"not_in/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("enum.not_in")}),
		},
		"alias/not_in/valid": {
