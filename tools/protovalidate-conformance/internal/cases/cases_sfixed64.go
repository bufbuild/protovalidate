		...
		"const/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must equal 1"),
				},
			),
		},
		"in/valid": {
		...
		"in/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must be in list [2, 3]"),
				},
			),
		},
		"not in/valid": {
		...
		"not in/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must not be in list [0]"),
				},
			),
		},
		"lt/valid": {
		...
		"lte/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must be less than or equal to 64"),
				},
			),
		},
		"gt/valid": {
		...
		"gte/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must be greater than or equal to 8"),
				},
			),
		},
		"gt_lt/valid": {
		...
		"gt_lt/above/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must be greater than 0 and less than 10"),
				},
			),
		},
		"gt_lt/below/invalid": {
		...
		"exclusive/gt_lt/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must be greater than 10 or less than 0"),
				},
			),
		},
		...
		"gte_lte/above/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must be greater than or equal to 128 and less than or equal to 256"),
				},
			),
		},
		...
		"exclusive/gte_lte/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must be greater than or equal to 256 or less than or equal to 128"),
				},
			),
		},
