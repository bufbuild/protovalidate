...
func ignoreSuite() suites.Suite {
	return suites.Suite{
		...
		"proto2/scalar/optional/ignore_unspecified/invalid/populated": suites.Case{
			Message:  &cases.Proto2ScalarOptionalIgnoreUnspecified{Val: proto.Int32(-123)},
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("int32.gt")}),
		},
		...
		"proto2/message/optional/ignore_unspecified/invalid/populated": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("proto2.message.ignore.empty")}),
		},
		...
		"proto2/repeated/ignore_unspecified/invalid/unpopulated": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("repeated.min_items")}),
		},
		...
		"proto2/map/ignore_unspecified/invalid/unpopulated": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("map.min_pairs")}),
		},
		...
		"proto2/repeated/items/ignore_unspecified/invalid/populated": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val[0]"), ConstraintId: proto.String("int32.gt")}),
		},
		...
		"proto2/map/keys/ignore_unspecified/invalid/populated": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val[-42]"), ForKey: proto.Bool(true), ConstraintId: proto.String("int32.gt")}),
		},
		"proto2/map/keys/ignore_unspecified/invalid/zero": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val[0]"), ForKey: proto.Bool(true), ConstraintId: proto.String("int32.gt")}),
		},
		...
		"proto2/map/values/ignore_unspecified/invalid/populated": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val[-42]"), ConstraintId: proto.String("int32.gt")}),
		},
		...
		"proto3/message/optional/ignore_unspecified/invalid/populated": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("proto3.message.ignore.empty")}),
		},
		...
		"proto/2023/message/explicit_presence/length_prefixed/ignore_unspecified/invalid/populated": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("proto.editions.message.ignore.empty")}),
		},
