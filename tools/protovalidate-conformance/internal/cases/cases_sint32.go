	...
	return suites.Suite{
		...
		"const/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					RulePath:     proto.String("sint32.const"),
		...
		"in/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					FieldPath:    proto.String("val"),
					RulePath:     proto.String("sint32.in"),
					ConstraintId: proto.String("sint32.in"),
				},
			),
		},
		"not_in/valid": {
		...
		"not_in/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					FieldPath:    proto.String("val"),
					RulePath:     proto.String("sint32.not_in"),
					ConstraintId: proto.String("sint32.not_in"),
				},
			),
		},
		"lt/valid/less": {
		...
		"lte/invalid/greater": {
			...
			Expected: results.Violations(
				&validate.Violation{
					FieldPath:    proto.String("val"),
					RulePath:     proto.String("sint32.lte"),
					ConstraintId: proto.String("sint32.lte"),
				},
			),
		},
		"gt/valid/greater": {
		...
		"gt/invalid/equal": {
			...
			Expected: results.Violations(
				&validate.Violation{
					FieldPath:    proto.String("val"),
					RulePath:     proto.String("sint32.gt"),
					ConstraintId: proto.String("sint32.gt"),
				},
			),
		},
		"gt/invalid/less": {
		...
		"gte/invalid/less": {
			...
			Expected: results.Violations(
				&validate.Violation{
					FieldPath:    proto.String("val"),
					RulePath:     proto.String("sint32.gte"),
					ConstraintId: proto.String("sint32.gte"),
				},
			),
		},
		...
		"gt_lt/inclusive/invalid/above": {
			...
			Expected: results.Violations(
				&validate.Violation{
					FieldPath:    proto.String("val"),
					RulePath:     proto.String("sint32.gt"),
					ConstraintId: proto.String("sint32.gt_lt"),
				},
			),
		},
		...
		"gt_lt/exclusive/invalid/within": {
			...
			Expected: results.Violations(
				&validate.Violation{
					FieldPath:    proto.String("val"),
					RulePath:     proto.String("sint32.gt"),
					ConstraintId: proto.String("sint32.gt_lt_exclusive"),
				},
			),
		},
		...
		"gte_lte/inclusive/invalid/above": {
			...
			Expected: results.Violations(
				&validate.Violation{
					FieldPath:    proto.String("val"),
					RulePath:     proto.String("sint32.gte"),
					ConstraintId: proto.String("sint32.gte_lte"),
				},
			),
		},
		...
		"gte_lte/exclusive/invalid/within": {
			...
			Expected: results.Violations(
				&validate.Violation{
					FieldPath:    proto.String("val"),
					RulePath:     proto.String("sint32.gte"),
					ConstraintId: proto.String("sint32.gte_lte_exclusive"),
				},
			),
		},
