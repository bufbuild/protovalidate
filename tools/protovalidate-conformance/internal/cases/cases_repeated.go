		...
		"min/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must contain at least 2 item(s)"),
				},
			),
		},
		"min/element/invalid": {
		...
		"max/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must contain no more than 3 item(s)"),
				},
			),
		},
		"min/max/valid": {
		...
		"min/max/above/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Rule:    results.FieldPath("repeated.max_items"),
					RuleId:  proto.String("repeated.max_items"),
					Message: proto.String("must contain no more than 4 item(s)"),
				},
			),
		},
		"exact/valid": {
		...
		"exact/below/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Rule:    results.FieldPath("repeated.min_items"),
					RuleId:  proto.String("repeated.min_items"),
					Message: proto.String("must contain at least 3 item(s)"),
				},
			),
		},
		"exact/above/invalid": {
		...
		"items/pattern/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("does not match regex pattern `(?i)^[a-z0-9]+$`"),
				},
			),
		},
		"items/in/invalid": {
		...
		"items/not_in/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must not be in list [foo, bar]"),
				},
			),
		},
		"items/not_in/valid": {
		...
		"items/enum/in/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Message: proto.String("must be in list [0]"),
				},
			),
		},
		"items/enum/in/valid": {
		...
		"min-and-items/len/min/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Rule:    results.FieldPath("repeated.min_items"),
					RuleId:  proto.String("repeated.min_items"),
					Message: proto.String("must contain at least 1 item(s)"),
				},
			),
		},
