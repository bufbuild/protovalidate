	...
	return suites.Suite{
		...
		"const/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.const")}),
		},
		"in/valid": {
		...
		"in/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.in")}),
		},
		"not_in/valid": {
		...
		"not_in/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.not_in")}),
		},
		"len/valid/ascii": {
		...
		"len/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.len")}),
		},
		...
		"min_len/invalid/less": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.min_len")}),
		},
		"max_len/valid/equal": {
		...
		"max_len/invalid/greater": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.max_len")}),
		},
		...
		"len_bytes/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.len_bytes")}),
		},
		...
		"min_bytes/invalid/less": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.min_bytes")}),
		},
		...
		"max_bytes/invalid/greater": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.max_bytes")}),
		},
		...
		"pattern/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.pattern")}),
		},
		...
		"prefix/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.prefix")}),
		},
		...
		"contains/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.contains")}),
		},
		"not_contains/valid": {
		...
		"not_contains/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.not_contains")}),
		},
		"suffix/valid/exact": {
		...
		"suffix/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.suffix")}),
		},
		"email/valid/simple": {
		...
		"email/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.email_empty")}),
		},
		...
		"email/invalid/malformed": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.email")}),
		},
		...
		"hostname/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.hostname_empty")}),
		},
		...
		"hostname/invalid/malformed": {
			Message: &cases.StringHostname{Val: "@!#$%^&*&^%$#"},
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.hostname")}),
		},
		...
		"ip/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ip")}),
		},
		...
		"ip/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ip_empty")}),
		},
		"ipv4/valid": {
		...
		"ipv4/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv4_empty")}),
		},
		...
		"ipv4/invalid/malformed": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv4")}),
		},
		...
		"ipv6/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv6_empty")}),
		},
		...
		"ipv6/invalid/malformed": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv6")}),
		},
		...
		"ip_with_prefixlen/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ip_with_prefixlen")}),
		},
		...
		"ip_with_prefixlen/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ip_with_prefixlen_empty")}),
		},
		...
		"ipv4_with_prefixlen/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv4_with_prefixlen_empty")}),
		},
		...
		"ipv4_with_prefixlen/invalid/malformed": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv4_with_prefixlen")}),
		},
		...
		"ipv6_with_prefixlen/invalid/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv6_with_prefixlen_empty")}),
		},
		...
		"ipv6_with_prefixlen/invalid/malformed": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv6_with_prefixlen")}),
		},
		...
		"ip_prefix/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ip_prefix_empty")}),
		},
		...
		"ip_prefix/invalid/malformed": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ip_prefix")}),
		},
		"ipv4_prefix/valid": {
		...
		"ipv4_prefix/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv4_prefix_empty")}),
		},
		...
		"ipv4_prefix/invalid/not_network_address": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv4_prefix")}),
		},
		...
		"ipv6_prefix/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv6_prefix_empty")}),
		},
		...
		"ipv6_prefix/invalid/not_network_address": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.ipv6_prefix")}),
		},
		...
		"uri/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.uri_empty")}),
		},
		...
		"uri/invalid/malformed": {
			Message: &cases.StringURI{Val: "!@#$%^&*"},
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.uri")}),
		},
		...
		"uri_ref/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.uri_ref")}),
		},
		...
		"address/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.address_empty")}),
		},
		...
		"address/invalid/hostname": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.address")}),
		},
		...
		"uuid/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.uuid_empty")}),
		},
		...
		"uuid/invalid/malformed": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.uuid")}),
		},
		...
		"tuuid/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.tuuid_empty")}),
		},
		...
		"tuuid/invalid/malformed": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.tuuid")}),
		},
		...
		"well_known_regex/header_name/strict/invalid/empty": {
			Message: &cases.StringHttpHeaderName{Val: ""},
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.well_known_regex.header_name_empty")}),
		},
		"well_known_regex/header_name/strict/invalid/solo_colon": {
			Message: &cases.StringHttpHeaderName{Val: ":"},
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.well_known_regex.header_name")}),
		},
		...
		"well_known_regex/header_value/strict/invalid/nul": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.well_known_regex.header_value")}),
		},
		...
		"host_and_port/invalid/empty": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.host_and_port_empty")}),
		},
		"host_and_port/invalid/missing_port": {
			Message: &cases.StringHostAndPort{Val: "localhost"},
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.host_and_port")}),
		},
		...
		"host_and_port/optional_port/invalid/malformed_hostname": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("string.host_and_port.optional_port")}),
		},
