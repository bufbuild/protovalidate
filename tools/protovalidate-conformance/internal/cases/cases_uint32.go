	...
	return suites.Suite{
		...
		"const/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{FieldPath: "val", ConstraintId: "uint32.const"}),
		},
		"in/valid": {
		...
		"in/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{FieldPath: "val", ConstraintId: "uint32.in"}),
		},
		"not_in/valid": {
		...
		"not_in/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{FieldPath: "val", ConstraintId: "uint32.not_in"}),
		},
		"lt/valid/less": {
		...
		"lt/invalid/equal": {
			...
			Expected: results.Violations(
				&validate.Violation{FieldPath: "val", ConstraintId: "uint32.lt"}),
		},
		"lt/invalid/greater": {
		...
		"lte/invalid/greater": {
			...
			Expected: results.Violations(
				&validate.Violation{FieldPath: "val", ConstraintId: "uint32.lte"}),
		},
		"gt/valid/greater": {
		...
		"gt/invalid/equal": {
			...
			Expected: results.Violations(
				&validate.Violation{FieldPath: "val", ConstraintId: "uint32.gt"}),
		},
		"gt/invalid/less": {
		...
		"gte/invalid/less": {
			...
			Expected: results.Violations(
				&validate.Violation{FieldPath: "val", ConstraintId: "uint32.gte"}),
		},
		...
		"gt_lt/inclusive/invalid/above": {
			...
			Expected: results.Violations(
				&validate.Violation{FieldPath: "val", ConstraintId: "uint32.gt_lt"}),
		},
		...
		"gt_lt/exclusive/invalid/within": {
			...
			Expected: results.Violations(
				&validate.Violation{FieldPath: "val", ConstraintId: "uint32.gt_lt_exclusive"}),
		},
		...
		"gte_lte/inclusive/invalid/above": {
			...
			Expected: results.Violations(
				&validate.Violation{FieldPath: "val", ConstraintId: "uint32.gte_lte"}),
		},
		...
		"gte_lte/exclusive/invalid/within": {
			...
			Expected: results.Violations(
				&validate.Violation{FieldPath: "val", ConstraintId: "uint32.gte_lte_exclusive"}),
		},
