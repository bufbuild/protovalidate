...
func ignoreEmptySuite() suites.Suite {
	return suites.Suite{
		...
		"proto2/message/zero": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("ignore_empty.proto2.message")}),
		},
		...
		"proto3/message/zero": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("ignore_empty.proto3.message")}),
		},
		...
		"proto3/map/keys/nonzero/invalid": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String(`val["x"]`), ForKey: proto.Bool(true), ConstraintId: proto.String("string.min_len")}),
		},
		...
		"proto3/map/values/nonzero/invalid": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String(`val["foo"]`), ConstraintId: proto.String("int32.gt")}),
		},
		...
		"proto/2023/message/explicit_presence/length_prefixed/zero": suites.Case{
			...
			Expected: results.Violations(&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("ignore_empty.editions.message")}),
		},
