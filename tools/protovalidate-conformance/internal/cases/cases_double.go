	...
	return suites.Suite{
		...
		"const/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("double.const")}),
		},
		"const/invalid_nan": {
		...
		"in/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("double.in")}),
		},
		"in/invalid_nan": {
		...
		"not_in/invalid": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("double.not_in")}),
		},
		"lt/valid/less": {
		...
		"lt/invalid/equal": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("double.lt")}),
		},
		"lt/invalid/greater": {
			Message: &cases.DoubleLT{Val: 1},
			Expected: results.Violations(
		...
		"lte/invalid/greater": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("double.lte")}),
		},
		"lte/invalid/nan": {
		...
		"gt/invalid/equal": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("double.gt")}),
		},
		"gt/invalid/less": {
		...
		"gte/invalid/less": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("double.gte")}),
		},
		"gte/invalid/nan": {
		...
		"gt_lt/inclusive/invalid/above": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("double.gt_lt")}),
		},
		...
		"gt_lt/exclusive/invalid/within": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("double.gt_lt_exclusive")}),
		},
		...
		"gte_lte/inclusive/invalid/above": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("double.gte_lte")}),
		},
		...
		"gte_lte/exclusive/invalid/within": {
			...
			Expected: results.Violations(
				&harness.Violation{FieldPath: proto.String("val"), ConstraintId: proto.String("double.gte_lte_exclusive")}),
		},
